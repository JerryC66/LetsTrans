export default {
  ...
  'menu.projects.translate': "Let's Trans!",
  ...
  'project.target_language': 'Target Language',
  'project.create': 'Create Project',

  'project.file.upload': 'Upload File',
  'project.file.name': 'File Name',
  'project.file.type': 'File Type',
  'project.file.date': 'Created Date',
